-- ----------------------------
-- Table structure for usr_func 角色所能做的事情
-- ----------------------------
...
-- ----------------------------
-- Table structure for usr_role角色，根据ID区分
-- ----------------------------
...
-- ----------------------------
-- Table structure for usr_role_func角色和动作对应表
-- ----------------------------
...
-- ----------------------------
-- Table structure for usr_user用户表，使用ID区分
-- ----------------------------
...
-- ----------------------------
-- Table structure for usr_user_role角色表
-- ----------------------------
